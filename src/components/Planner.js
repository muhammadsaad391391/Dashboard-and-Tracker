...
export function renderPlanner(container, state) {
  ...
  container.innerHTML = `
    ...
    <!-- 📊 Project Queue & Health Scheduler -->
    <div style="margin-bottom: 20px;">
      ${getProjectQueueCardHTML(state, processedProjects, {
        cardTitle: '📊 Project Queue & Daily Scheduler',
  ...
  // Bind Project Queue events in Planner
  bindProjectQueueEvents(container, state, () => renderPlanner(container, state), { idPrefix: 'pl-' });
